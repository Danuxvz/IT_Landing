...
export default function Experience() {
  return (
    <div className="experience-section shadow-lg">
      <h2 className="section-title">Experience</h2>

      <div className="experience-item">
        <h5 className="fw-bold">Freelance Developer</h5>
        <h6 className="">Aug 2025 - Present</h6>
        <ul>
      ...
      <div className="experience-item">
        <h5 className="fw-bold">South Tampa Logistics [Store Associate]</h5>
        <h6 className="">Aug 2021 - May 2023</h6>
        <ul>
